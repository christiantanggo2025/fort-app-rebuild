...
export default function EventsDashboardScreen() {
  ...
  const buttons = [
    {
      label: 'New Events',
      onPress: () => navigation.navigate('UploadEventsCalendarScreen'),
    },
    {
      label: 'Existing Events',
      onPress: () => navigation.navigate('ViewExistingEvents'), // ✅ FIXED
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.headerRow}>
        ...
        <Text style={styles.headerText}>Events Dashboard</Text>
        <View style={{ width: 24 }} />
      </View>
